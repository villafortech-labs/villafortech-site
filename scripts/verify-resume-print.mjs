...
const RESUMES = [
  {
    ...
    requiredText: [
      ...
      'Auditable ML policy lab',
      'Bio-inspired optimization benchmark',
  ...
  },
  {
    ...
    requiredText: [
      ...
      'github.com/VillaforTech',
      'diciembre de 2026',
      'Laboratorio auditable de políticas de ML',
      'Benchmark de optimización bioinspirada',
      'proyecto integrador en curso',
    ],
    route: '/es/resume/',
  },
];
